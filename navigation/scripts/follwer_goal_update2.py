...
rospy.init_node('movebase_action_client2')
...
if __name__ == '__main__':
    try:
        rospy.Subscriber('/volta_2/amcl_pose', PoseWithCovarianceStamped, poseLeader)
        rospy.Subscriber('/volta_3/amcl_pose', PoseWithCovarianceStamped, poseFollower)
